...
var n=O;O=t;try{return e.apply(this,arguments)}finally{O=n}}},"undefined"!=typeof __REACT_DEVTOOLS_GLOBAL_HOOK__&&"function"==typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop&&__REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(Error())}()});var l={};l=o("7B2bR");/** Joplin Link
 *
 *
 ...
 */const u=/^\/j\/(?<action>[nft])\/(?<id>[A-Za-z0-9]{32})/,s={Note:"n",Folder:"f",Tag:"t"},c={n:"Note",f:"Folder",t:"Tag"};function d(e){try{return new URL(e),!0}catch{return!1}}Object.freeze({Joplin:"joplin",Universal:"universal"});class f{constructor(){}encode(e){let t=new TextEncoder().encode(e);return btoa(String.fromCodePoint(...t)).replace(/\+/g,"-").replace(/\//g,"_")}decode(e){let t=atob(e.replace(/_/g,"/")),n=Uint8Array.from(t,e=>e.codePointAt(0));return new TextDecoder().decode(n)}}const p=/^\/u\/(?<encoded>[A-Za-z0-9_\-=]+)/,h=[new class{constructor(){}encodeLink(e){let t=e.match("joplin://x-callback-url/open(?<action>Note|Folder|Tag)?\\?id=(?<id>[A-Za-z0-9]{32})");if(null==t)return;let n=t.groups.id,r=s[t.groups.action];return`/j/${r}/${n}`}decodePath(e){let t=e.match(u);if(null==t)return;let n=t.groups.id,r=c[t.groups.action];return`joplin://x-callback-url/open${r}?id=${n}`}isEncodedPath(e){return null!=this.decodePath(e)}canEncodeLink(e){return null!=this.encodeLink(e)}},new class{constructor(){this.endecoder=new f}encodeLink(e){return"/u/"+this.endecoder.encode(e)}decodePath(e){let t=e.match(p);if(null===t)return;let n=t.groups.encoded.replace(/-/g,"+").replace(/_/g,"/"),r=this.endecoder.decode(n).trim();return r}isEncodedPath(e){let t=e.match(p);// check is base64
return null!=t&&null!=t.groups.encoded}canEncodeLink(e){return this.isValidateLink(e)}isValidateLink(e){//@TODO - test case
// mailto: xxx
// javascript: ?
try{return new URL(e),!0}catch(e){return!1}}}];class m{decode(e,t){let n=t.pathname.replace(RegExp(`^${e}`),""),r=h.find(e=>e.isEncodedPath(n));if(void 0!==r)//@todo - validate the link
return r.decodePath(n)}encode(e,t){let n=h.find(e=>e.canEncodeLink(t));if(void 0!==n)return[e,n.encodeLink(t)].join("")}}o("acw62");var v=o("acw62"),y={},g={};g=function(){var e=document.getSelection();if(!e.rangeCount)return function(){};for(var t=document.activeElement,n=[],r=0;r<e.rangeCount;r++)n.push(e.getRangeAt(r));switch(t.tagName.toUpperCase()){case"INPUT":case"TEXTAREA":t.blur();break;default:t=null}return e.removeAllRanges(),function(){"Caret"===e.type&&e.removeAllRanges(),e.rangeCount||n.forEach(function(t){e.addRange(t)}),t&&t.focus()}};var b={"text/plain":"Text","text/html":"Url",default:"Text"};y=function(e,t){var n,r,a,o,i,l,u,s,c=!1;t||(t={}),a=t.debug||!1;try{if(i=g(),l=document.createRange(),u=document.getSelection(),(s=document.createElement("span")).textContent=e,// avoid screen readers from reading out loud the text
...
s.style.webkitUserSelect="text",s.style.MozUserSelect="text",s.style.msUserSelect="text",s.style.userSelect="text",s.addEventListener("copy",function(n){if(n.stopPropagation(),t.format){if(n.preventDefault(),void 0===n.clipboardData){a&&console.warn("unable to use e.clipboardData"),a&&console.warn("trying IE specific stuff"),window.clipboardData.clearData();var r=b[t.format]||b.default;window.clipboardData.setData(r,e)}else n.clipboardData.clearData(),n.clipboardData.setData(t.format,e)}t.onCopy&&(n.preventDefault(),t.onCopy(n.clipboardData))}),document.body.appendChild(s),l.selectNodeContents(s),u.addRange(l),!document.execCommand("copy"))throw Error("copy command was unsuccessful");c=!0}catch(i){a&&console.error("unable to copy using execCommand: ",i),a&&console.warn("trying IE specific stuff");try{window.clipboardData.setData(t.format||"text",e),t.onCopy&&t.onCopy(window.clipboardData),c=!0}catch(i){a&&console.error("unable to copy using clipboardData: ",i),a&&console.error("falling back to prompt"),n="message"in t?t.message:"Copy to clipboard: #{key}, Enter",r=(/mac os x/i.test(navigator.userAgent)?"⌘":"Ctrl")+"+C",o=n.replace(/#{\s*key\s*}/g,r),window.prompt(o,e)}}finally{u&&("function"==typeof u.removeRange?u.removeRange(l):u.removeAllRanges()),s&&document.body.removeChild(s),i()}return c};const w={host:"https://benlau.github.io",uriPrefix:"/l",helpUrl:"https://github.com/benlau/l"};var k=function(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];return e.reduce(function(e,n,r){var a=t[r];return"string"==typeof a?""+e+n+a:""+e+n},"").trim().replace(/\s{2,}/g," ")};function S(e){let{children:t}=e;return/*#__PURE__*/(0,l.jsx)("div",{className:"flex flex-row w-full p-8 justify-center",children:/*#__PURE__*/(0,l.jsx)("div",{className:"flex flex-col w-[600px] gap-2 rounded border border-[#858F99] p-4",children:t})})}o("acw62"),o("acw62");var x={};function C(e){let{className:n,children:r}=e,a=/*@__PURE__*/t(x)("text-lg font-bold text-[#1F2937]",n);return/*#__PURE__*/(0,l.jsx)("div",{className:a,children:r})}function E(e){let{children:n,onClick:r}=e,a=/*@__PURE__*/t(v).useCallback(e=>{e.preventDefault(),e.stopPropagation(),r?.(e)},[r]);return/*#__PURE__*/(0,l.jsx)("button",{onClick:a,className:"hover:opacity-70 active:opacity-50 text-[#0969DA]",children:n})}!/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*//* global define */function(){var e={}.hasOwnProperty;function t(){for(var n=[],r=0;r<arguments.length;r++){var a=arguments[r];if(a){var o=typeof a;if("string"===o||"number"===o)n.push(a);else if(Array.isArray(a)){if(a.length){var i=t.apply(null,a);i&&n.push(i)}}else if("object"===o){if(a.toString!==Object.prototype.toString&&!a.toString.toString().includes("[native code]")){n.push(a.toString());continue}for(var l in a)e.call(a,l)&&a[l]&&n.push(l)}}}return n.join(" ")}x?(t.default=t,x=t):"function"==typeof define&&"object"==typeof define.amd&&define.amd?define("classnames",[],function(){return t}):window.classNames=t}();var v=(o("acw62"),o("acw62"));function R(){let e=/*@__PURE__*/t(v).useCallback(()=>{window.open(w.helpUrl,"_blank")},[]);return/*#__PURE__*/(0,l.jsx)(E,{onClick:e,children:"What is it?"})}const T=new m,_={InvalidURL:"InvalidURL",JavaScriptNotAllowed:"JavaScriptNotAllowed",FileURL:"FileURL"},P={[_.InvalidURL]:"Your app link is not valid",[_.JavaScriptNotAllowed]:"Embed JavaScript in the link is forbidden"};function D(e){let{children:t,onClick:n,isDisabled:r}=e,a=k`
        border-l-[#D0D6DE] 
        border-l-[1px] 
        p-1 
        min-w-[70px] 
    ...
    `;return/*#__PURE__*/(0,l.jsx)("button",{onClick:n,className:a,disabled:r,children:t})}function O(e){let{inputLink:n,convertedLink:r,info:a,inputLinkRef:o,onInputLinkChange:i,onCopyClick:u,onTestClick:s,isCopiedVisible:c,copyRedirectLink:d,convertToVSCode:f}=e,p=k`
        border border-[#D0D6DE] bg-[#f6f8fa] rounded p-1
        w-full resize-none
    `,h=/*@__PURE__*/t(v).useCallback(e=>{"Enter"===e.key&&(e.preventDefault(),e.stopPropagation(),d())},[d]),m=k`
        text-gray-500
        h-11
        p-2
        ${!a&&"invisible"}
    `;return/*#__PURE__*/(0,l.jsxs)(S,{children:[/*#__PURE__*/(0,l.jsxs)("div",{children:[/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flex-row justify-between items-center mb-2",children:[/*#__PURE__*/(0,l.jsx)(C,{children:"App Link"}),/*#__PURE__*/(0,l.jsx)(R,{})]}),/*#__PURE__*/(0,l.jsx)("textarea",{ref:o,className:p,rows:"5",onChange:i,value:n,onKeyDown:h,placeholder:"Put your app link here"}),/*#__PURE__*/(0,l.jsx)("div",{className:m,children:a===_.FileURL?/*#__PURE__*/(0,l.jsxs)("div",{children:["File link is not working. Try vscode:// ?"," ",/*#__PURE__*/(0,l.jsx)(E,{onClick:f,children:"Yes"})]}):void 0!==a?/*#__PURE__*/(0,l.jsx)("div",{children:P[a]}):null})]}),/*#__PURE__*/(0,l.jsx)(C,{children:"Converted Web Link"}),/*#__PURE__*/(0,l.jsxs)("div",{className:"border bg-[#f6f8fa] border-[#D0D6DE] rounded flex flex-row justify-between items-center",children:[/*#__PURE__*/(0,l.jsx)("div",{className:"p-1 truncate",children:r}),/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flex-row",children:[/*#__PURE__*/(0,l.jsx)(D,{onClick:s,isDisabled:""===r.trim(),children:"Test"}),/*#__PURE__*/(0,l.jsx)(D,{onClick:u,isDisabled:""===r.trim(),children:c?"Copied":"Copy"})]})]})]})}var v=o("acw62");const L=["javascript://"];function N(e){let{heading:t,redirectLink:n,onCloseClick:r}=e;return/*#__PURE__*/(0,l.jsx)(S,{children:/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flex-col gap-4 mt-2",children:[/*#__PURE__*/(0,l.jsx)(C,{children:t}),/*#__PURE__*/(0,l.jsx)("div",{className:"underline bg-[#f6f8fa] p-2 rounded border border-[#D0D6DE] break-all line-through",children:n}),/*#__PURE__*/(0,l.jsx)("div",{className:"flex flex-row justify-between mt-8",children:/*#__PURE__*/(0,l.jsx)("button",{className:"border px-4 py-1 rounded bg-[#f6f8fa] hover:opacity-70 active:opacity-50",onClick:r,children:"Close"})})]})})}function I(e){let{redirectLink:t,contentType:n,onProceedClick:r,isInWhitelist:a,onAlwaysShowClick:o,onCloseClick:i,isDisallowed:u,isLinkValid:s}=e;return s?u?/*#__PURE__*/(0,l.jsx)(N,{heading:`${n} is forbidden`,redirectLink:t,onCloseClick:i}):/*#__PURE__*/(0,l.jsxs)(S,{children:[/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flew-row justify-between",children:[/*#__PURE__*/(0,l.jsx)(C,{children:"You are being redirected to"}),/*#__PURE__*/(0,l.jsx)(R,{})]}),/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flex-col gap-4 mt-2",children:[/*#__PURE__*/(0,l.jsx)("div",{className:"underline bg-[#f6f8fa] p-2 rounded border border-[#D0D6DE] break-all",children:/*#__PURE__*/(0,l.jsx)("a",{href:t,children:t})}),/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flex-row gap-2",children:[a?/*#__PURE__*/(0,l.jsx)("input",{type:"checkbox",defaultChecked:!0,readOnly:!0,onClick:o},1):/*#__PURE__*/(0,l.jsx)("input",{type:"checkbox",readOnly:!0,onClick:o},2),/*#__PURE__*/(0,l.jsxs)("div",{className:"select-none",onClick:o,children:["Auto open ",n]})]})]}),/*#__PURE__*/(0,l.jsxs)("div",{className:"flex flex-row justify-between mt-8",children:[/*#__PURE__*/(0,l.jsx)("button",{className:"border px-4 py-1 rounded bg-[#f6f8fa] hover:opacity-70 active:opacity-50",onClick:i,children:"Close"}),/*#__PURE__*/(0,l.jsx)(E,{className:"hover:opacity-70 active:opacity-50 text-[#0969DA]",onClick:r,children:"Open"})]})]}):/*#__PURE__*/(0,l.jsx)(N,{heading:"Invalid link detected.",redirectLink:t,onCloseClick:i})}var M={},z=(M=o("3y30c")).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;const j=new m,U=w.uriPrefix,A=new URL(window.location.href),F=j.decode(U,A),W=document.getElementById("root"),B=function(e,t){z.usingClientEntryPoint=!0;try{return M.createRoot(e,void 0)}finally{z.usingClientEntryPoint=!1}}(W);void 0!==F?B.render(/*#__PURE__*/(0,l.jsx)(function(e){let n=function(e){let{redirectLink:n}=e,[r,a]=function(e,n){let r=/*@__PURE__*/t(v).useCallback(()=>{let t=localStorage.getItem(e);if(null==t)return n;try{return JSON.parse(t)}catch{return n}},[e,n]),[a,o]=/*@__PURE__*/t(v).useState(()=>r()),i=/*@__PURE__*/t(v).useCallback(t=>{let n=t(r());localStorage.setItem(e,JSON.stringify(n)),o(n)},[e,r]);return[a,i]}("ianylink_allowlist",{}),[o,i]=/*@__PURE__*/t(v).useState(!1),[l,u]=/*@__PURE__*/t(v).useState(!1),s=d(n),c=/*@__PURE__*/t(v).useMemo(()=>{try{let e=new URL(n);if("http:"===e.protocol||"https:"===e.protocol)return`${e.protocol}//${e.hostname}`;return e.protocol+"//"}catch{return""}},[n]);/*@__PURE__*/t(v).useEffect(()=>{if(L.includes(c)){i(!1),u(!0);return}let e=!0===r[c];i(e),e&&window.open(n,"_self");// eslint-disable-next-line react-hooks/exhaustive-deps
},[]);let f=/*@__PURE__*/t(v).useCallback(()=>{window.open(n,"_self")},[n]),p=/*@__PURE__*/t(v).useCallback(e=>{e.preventDefault(),e.stopPropagation(),i(e=>(a(t=>(t[c]=!e,t)),!e))},[c,a]),h=/*@__PURE__*/t(v).useCallback(e=>{e.preventDefault(),e.stopPropagation(),window.close()},[]);return /*@__PURE__*/t(v).useMemo(()=>({redirectLink:n,onProceedClick:f,contentType:c,isInWhitelist:o,onAlwaysShowClick:p,onCloseClick:h,isDisallowed:l,isLinkValid:s}),[n,c,o,f,p,h,l,s])}(e);return/*#__PURE__*/(0,l.jsx)(I,{...n})},{redirectLink:F})):B.render(/*#__PURE__*/(0,l.jsx)(function(){let e=function(){let[e,n]=/*@__PURE__*/t(v).useState(""),[r,a]=/*@__PURE__*/t(v).useState(""),[o,i]=/*@__PURE__*/t(v).useState(void 0),l=/*@__PURE__*/t(v).useRef(null),u=/*@__PURE__*/t(v).useCallback(e=>{e.preventDefault(),e.stopPropagation(),n(e.target.value.replace(/(\r\n|\r|\n)/g,""))},[]),[s,c]=/*@__PURE__*/t(v).useState(!1),f=/*@__PURE__*/t(v).useCallback(()=>{let t=e.trim();if(""===t){a(""),i();return}if(!1===d(t)){e.length>10?i(_.InvalidURL):i(),a("");return}if(t.startsWith("javascript:")){i(_.JavaScriptNotAllowed),a("");return}try{a(T.encode([w.host,w.uriPrefix].join(""),t)),i()}catch(e){console.error({e:e}),a("");return}try{let e=new URL(t);"file:"===e.protocol&&i(_.FileURL)}catch{// ignore
}},[e]);/*@__PURE__*/t(v).useEffect(()=>{f()},[f]);let p=/*@__PURE__*/t(v).useCallback(()=>{""!==r.trim()&&(/*@__PURE__*/t(y)(r),c(!0),setTimeout(()=>{c(!1)},1e3))},[r]),h=/*@__PURE__*/t(v).useCallback(e=>{e.preventDefault(),e.stopPropagation(),p()},[p]),m=/*@__PURE__*/t(v).useCallback(e=>{e.preventDefault(),e.stopPropagation(),""!==r.trim()&&window.open(r,"_blank")},[r]),g=/*@__PURE__*/t(v).useCallback(()=>{try{var t,r,a;let o=new URL(e);n((t=o.pathname,r=o.hash,a=o.search,`vscode://${["file",t,r,a].filter(Boolean).join("")}`))}catch{// ignore
}},[e]);return /*@__PURE__*/t(v).useMemo(()=>({inputLink:e,convertedLink:r,info:o,inputLinkRef:l,onInputLinkChange:u,onCopyClick:h,onTestClick:m,isCopiedVisible:s,copyRedirectLink:p,convertToVSCode:g}),[e,r,o,l,u,h,m,s,p,g])}();return/*#__PURE__*/(0,l.jsx)(O,{...e})},{}));//# sourceMappingURL=index.d6e48a25.js.map

//# sourceMappingURL=index.d6e48a25.js.map
